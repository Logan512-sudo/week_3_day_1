...
print("The " + str(age) + " year old coder lived for over " + str(number) + " years")
...
print("the max of 2 and 3 is",max(2,3)) #biggest number
print("the min of 2 and 3 is",min(2,3)) #lowest number
# #round a number
...
print("the floor of 5.8 is",floor(5.8))
# #ceil method
print("the ceil of 3.7 is",ceil(3.7))
print("the ceil of 5.8 is",ceil(5.8))
# #sqrt method
